...
export function meta({ params: { slug } }: Route.MetaArgs) {
  ...
  return [
    { title: 'Artha Sign - Share' },
    { description: 'I just signed a document in style with Artha Sign!' },
    {
      property: 'og:title',
      content: 'Artha Sign - Join the open source signing revolution',
    },
    {
      property: 'og:description',
      content: 'I just signed with Artha Sign!',
    },
    {
      property: 'og:type',
      content: 'website',
...
export const loader = async ({ request, params: { slug } }: Route.LoaderArgs) => {
  ...
  // Is hardcoded because this whole meta is hardcoded anyway for Artha Sign.
