                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormDescription>
                        <Trans>The URL for Artha Sign to send webhook events to.</Trans>
                      </FormDescription>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      <Trans>
                        A secret that will be sent to your URL so you can verify that the request has been sent by Artha
                        Sign.
                      </Trans>
                    </FormDescription>
                    <FormMessage />
