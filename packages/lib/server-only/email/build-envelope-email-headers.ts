 ...
 * to the originating Artha Sign user via the admin panel.
 *
...
export const buildEnvelopeEmailHeaders = ({
  ...
  return {
    'X-Artha Sign-Sender-User-Id': String(userId),
    'X-Artha Sign-Envelope-Id': envelopeId,
    'X-Artha Sign-Team-Id': String(teamId),
  };
};
